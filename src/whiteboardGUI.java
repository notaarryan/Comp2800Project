...
class CanvasPanel extends JPanel { // canvas panel class, JPanel extended to override the paintComponent method for drawing

    public CanvasPanel() { // constructor for canvas panel 
        setVisible(true); // ensures panel is visible when added to the frame 
    }
}